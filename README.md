...
<head>
    ...
    <style>
        ...
        .button {
            ...
            color: rgb(0, 0, 0);
            border:10px solid rgb(19, 19, 20)
        }

        .button input[type="button"] {
            background-color:rgb(255, 110, 188);
            height: 50px;
            width: 50px;
            margin: 0 2px;
            border: 3px solid rgb(134, 5, 5);
        }
    </style>
</head>

<body style="background-color: #7ce9ff;">
        <h1 align="center" style="color: rgb(0, 0, 0);">SIMPLE CALCULATOR</h1>
	<h1 align="center" style="color: rgb(0, 0, 0);">DIVYA DHARSHINI R [212223040042]</h1>
        <div class="button">
            <center>
...
![alt text](<divi/calcapp/static/Screenshot 2024-05-06 092730.png>)
